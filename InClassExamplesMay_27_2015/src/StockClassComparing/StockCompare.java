package StockClassComparing;


import ObjectCopy.Stock;
...
public class StockCompare
{
   public static void main(String[] args)
   {
      ...
      if (company1.equals(company2))
         System.out.println("Both objects contain the same values.");
      else
         System.out.println("The objects contain different values.");
   }
}